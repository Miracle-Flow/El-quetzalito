...
export function QuetzalMark({ className = "h-10 w-10" }: IconProps) {
  return (
...
export function ChiliIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true" {...stroke}>
...
export function TacoIcon({ className = "h-8 w-8" }: IconProps) {
  return (
...
export function BurritoIcon({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg viewBox="0 0 32 32" className={className} aria-hidden="true" {...stroke}>
...
export function NachoIcon({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg viewBox="0 0 32 32" className={className} aria-hidden="true" {...stroke}>
