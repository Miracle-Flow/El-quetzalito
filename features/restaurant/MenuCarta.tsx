...
import { menuCategories, type MenuItem, type MenuCategory } from "@/features/restaurant/data/menu";

// An item annotated with the category it was selected from, for the detail panel.
type CartaItem = MenuItem & { _catId: string };

type CatMeta = { short: string; color: string; hover: string };
...
export default function MenuCarta() {
  ...
  const [selected, setSelected] = useState<CartaItem | null>(null);
  ...
  const selectItem = (item: CartaItem) => {
    setSelected(item);
      ...
      <div className="quetz-menu-content">
        ...
        <div className="quetz-menu-paper">
          ...
          <div
            ...
            style={
              { "--cat": meta.color, "--cat-hover": meta.hover } as React.CSSProperties
            }
          >
            {/* Header */}
